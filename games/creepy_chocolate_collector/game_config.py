...
class GameConfig(Config):
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "creepy_chocolate_collector"
        ...
        self.anticipation_triggers = {
            ...
            self.freegame_type: 0,  # No scatters in bonus
        }
        # Reels
        ...
        # Chocolate Cash values (× total bet)
        self.chocolate_cash_values = [2, 5, 10, 15, 20, 25, 50, 2000]
        
        # Collector Wild multiplier ladder: ×1 → ×2 → ×3 → ×10
                ...
                distributions=[
                    ...
                    Distribution(
                        ...
                        conditions={
                            ...
                            "scatter_triggers": {3: 70, 4: 25, 5: 5},
                            "mult_values": {
                                self.basegame_type: {1: 1},
                                self.freegame_type: {2: 100, 3: 80, 4: 50, 5: 20, 10: 10, 20: 5, 50: 1},
                            },
