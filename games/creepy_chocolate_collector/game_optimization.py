    ...
    def __init__(self, game_config):
        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    "freegame": ConstructConditions(
                        rtp=0.42, hr=100, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(hr=4.0, rtp=0.53).return_dict(),
                },
            ...
            "bonus": {
                "conditions": {
                    "wincap": ConstructConditions(rtp=0.01, av_win=10000, search_conditions=10000).return_dict(),
                    "freegame": ConstructConditions(rtp=0.95, hr=1.0).return_dict(),
                },
                "scaling": ConstructScaling(
                    [
                        {
            ...
            "antibet": {
                "conditions": {
                    ...
                    "0": ConstructConditions(rtp=0, av_win=0, search_conditions=0).return_dict(),
                    "freegame": ConstructConditions(
                        rtp=0.42, hr=67, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(hr=4.0, rtp=0.53).return_dict(),
                },
                "scaling": ConstructScaling(
